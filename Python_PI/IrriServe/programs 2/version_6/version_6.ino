...
int ledPin  = 13;//  the LED program pin
...
int soilPin = A0;//Declare a variable for the analog soil moisture sensor 
int soilPower = 7;//Variable for Soil moisture Power

int ledPin=12;
int sensorPin=8; //digital sol moisture sensor
...
void  setup()
{
  ...
  pinMode(sensorPin,INPUT); //digital soil moisture
}
void  loop() 
{ 
